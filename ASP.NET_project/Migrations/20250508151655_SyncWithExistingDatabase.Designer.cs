...
namespace ASP.NET_project.Migrations
{
    ...
    [Migration("20250508151655_SyncWithExistingDatabase")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ASP.NET_project.Models.Client", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ASP.NET_project.Models.Reservation", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ASP.NET_project.Models.Service", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ASP.NET_project.Models.Worker", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ClientReservation", b =>
                {
                    b.HasOne("ASP.NET_project.Models.Client", null)
                        .WithMany()
                        .HasForeignKey("clientsID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ASP.NET_project.Models.Reservation", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ReservationService", b =>
                {
                    ...
                    b.HasOne("ASP.NET_project.Models.Service", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ReservationWorker", b =>
                {
                    ...
                    b.HasOne("ASP.NET_project.Models.Worker", null)
                        .WithMany()
